...
def main(args: List = None) -> None:
    ...
    poses = [
        Pose(
            position=Point(x=-0.58195, y=-0.04636, z=0.55202),
            orientation=Quaternion(x=-0.064661, y=0.961, z=0.029782, w=-0.26724),
        ),
        Pose(
            position=Point(x=-0.640, y=-0.03489, z=0.34998),
            orientation=Quaternion(x=-0.064661, y=0.961, z=0.029782, w=-0.26724),
        ),
        # Pose(
        #     position=Point(x=-0.5967, y=0.27501, z=0.35003),
        #     orientation=Quaternion(x=-0.064661, y=0.961, z=0.029782, w=-0.26724),
        # )
    ]
