...
class RobotInterfaceNode(Node):
    ...
    move_group1_name_ = "kuka_blue"
    move_group2_name_ = "kuka_green"
    namespace_ = ""
    ...
    base1_ = "kuka_blue_link_0"
    base2_ = "kuka_green_link_0"
    end_effector1_ = "kuka_blue_link_ee"
    end_effector2_ = "kuka_green_link_ee"
    ...
    def get_ik(self, target_pose: Pose) -> JointState | None:
        ...
        request.ik_request.pose_stamped.header.frame_id = f"{tf_prefix}/{self.base1_}"
    ...
    def get_fk(self) -> Pose | None:
        ...
        request.header.frame_id = f"{self.namespace_}/{self.base1_}"
        request.header.stamp = self.get_clock().now().to_msg()

        request.fk_link_names.append(self.end_effector1_)
