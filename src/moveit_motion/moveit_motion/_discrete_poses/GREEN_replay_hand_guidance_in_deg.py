...
KB_HOME = [-0.5760490341607787, -1.016315242280703, -0.9238605423880089, -1.6872728661746639, 0.37536855022784543, 1.0636251272414456, 2.622149547846647]
...
def main_simple(robot_data):
    ...
    kb = MoveitInterface(node_name=f"client_real_kuka_green",     
...
if __name__ == "__main__":
    ...
    data_directory = Path("/mnt/rec_kuka_green")

    # Usage:
    #   - no args: use latest .log in /mnt/rec_kuka_green
