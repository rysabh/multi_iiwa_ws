...
if __name__ == "__main__":
    rclpy.init()
    ############################################################33
    checkpoint_path = '/home/cam/Downloads/checkpoints/checkpoint_vision_model_basic_fk_2_8_epoch_199.pth' 
    size = (120, 120)
    box_observation = [-1.8193931333973405, -0.5498025031068354, -0.24256838198835645, 1.7345882039803222, 1.396784326526648, 0.757696627486106, 2.284995790594959]
