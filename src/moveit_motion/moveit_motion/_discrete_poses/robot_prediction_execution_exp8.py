...
if __name__ == "__main__":
    rclpy.init()
    ############################################################33
    checkpoint_path = '/home/cam/Downloads/checkpoints/checkpoint_vision_model_basic_fk_with_box_pos_2_30_epoch_199.pth' 
    size = (120, 120)
    box_observation = [-1.7985407618718392, -0.5871599087166374, -0.28917904736276195, 1.7030143852518949, 1.365904813846381, 0.7133086164430011, 2.2730284035626656]
