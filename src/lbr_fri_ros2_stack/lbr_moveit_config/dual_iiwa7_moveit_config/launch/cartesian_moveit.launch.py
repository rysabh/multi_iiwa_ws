...
def generate_launch_description():
    moveit_config = (
        MoveItConfigsBuilder(
            "dual_iiwa7", package_name = "dual_iiwa7_moveit_config"
        )
    ...
    rviz_config_file = (
        get_package_share_directory("dual_iiwa7_moveit_config") + "/config/moveit.rviz"
    )
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("dual_iiwa7_moveit_config"),
        "config",
